...
const PRODUCT_FIELDS =
	'path,id,name,category_id,category_ids,category_name,sku,images,enabled,discontinued,stock_status,stock_quantity,price,on_sale,regular_price,price_range,min_price,max_price,regular_min_price,regular_max_price,attributes,tags,position';
